    ...
    <div className="mt-20 w-full text-white max-w-7xl mx-auto py-20 px-4">
      ...
      <div className="mb-16 text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-4">
          Shopify Developer Guides
        </h2>
        <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">
          Practical tutorials and snippets to help you integrate missing Shopify
          theme features — from wishlists to sticky carts and more.
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-10 items-stretch">
        {blogs.map((blog, index) => (
          <div
            key={index}
            className="w-full md:w-[calc(50%-1.25rem)] max-w-[600px] flex"
          >
            <BlogCard blog={blog} />
          </div>
        ))}
