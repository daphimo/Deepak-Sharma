...
import {
  ...
  Scene,
  WebGLRenderer,
  type WebGLRendererParameters, // Fixed: type-only import
  SRGBColorSpace,
  MathUtils,
  Vector2,
  Vector3,
...
// Extended interface to include defines property
interface YMaterial extends MeshPhysicalMaterial {
...
class Y extends MeshPhysicalMaterial {
  ...
  constructor(params: any) {
    ...
    // Fixed: Use type assertion to access defines
    (this as YMaterial).defines = { USE_UV: '' };
    ...
    this.onBeforeCompile = shader => {
      ...
      if ((this as YMaterial).onBeforeCompile2) (this as YMaterial).onBeforeCompile2!(shader);
    };
  }
}
